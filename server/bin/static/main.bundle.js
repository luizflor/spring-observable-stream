    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["G" /* NgModule */])({
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_7__stomp_ng2_stompjs__["b" /* StompService */],
                ...
                }, __WEBPACK_IMPORTED_MODULE_9__yo_service__["a" /* YoService */]],
...
var YoComponent = (function () {
    function YoComponent(_stompService, _yoService, vcr, modalService) {
        var _this = this;
    ...
    YoComponent.prototype.subscribe = function () {
        if (this.subscribed) {
            return;
        }
        // Stream of messages
    ...
    YoComponent.prototype.unsubscribe = function () {
        if (!this.subscribed) {
            return;
        }
